...
Here, we will build a simplfied diustributed log ana;lytics platform using Python. The system will simulate multiple
servers sending logs to a central analytics node, which will parse the data, store it using efficient data structure,
perform statistical analysis, detect anomalies, and visulaise system behaviour.
